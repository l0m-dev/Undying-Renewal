//=============================================================================
// ShellTextBox - A textbox 
//=============================================================================
class ShellTextBox extends ShellComponent;
...
function KeyDown(int Key, float X, float Y)
{
	...
	case P.EInputKey.IK_Enter:
		if(bCanEdit)
		{
			...
			SendMessage(DE_EnterPressed);
		}
		break;
	case P.EInputKey.IK_MWheelUp:
		if(bCanEdit)
			SendMessage(DE_WheelUpPressed);
		break;
	case P.EInputKey.IK_MWheelDown:
		if(bCanEdit)
			SendMessage(DE_WheelDownPressed);
		break;
...
function Paint(Canvas C, float X, float Y)
{
	...
	TextSize(C, Left(Caps(Value), CaretOffset), W, H);
	...
	{
		Offset = (WinWidth - 2) - W;
		if(Offset > 0) Offset = (WinWidth - W)/2;
	}
	...
	ClipText(C, Offset + 1, TextY,  Caps(Value));
