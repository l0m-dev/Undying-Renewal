...
function Created()
{
	...
	AliasCount = ArrayCount(AliasNames);
...
function OldVersionFallback()
{
	if ( InStr(Localize("ControlsWindow", "AliasNames[0]", "UndyingShellPC"), "<?") == 0 )
	{
		// using old version without AliasNames localization
		AliasCount = 60;
		...
		AliasNames[22] = "Button bSelectItem | SelectItem";
		AliasNames[23] = "PrevWeapon";
		AliasNames[24] = "NextWeapon";
		AliasNames[25] = "PrevAttSpell";
		AliasNames[26] = "NextAttSpell";
		AliasNames[27] = "ShowBook";
		AliasNames[28] = "DisplayObjectives";
		AliasNames[29] = "QuickSave";
		AliasNames[30] = "QuickLoad";
		AliasNames[31] = "SaveGame 1";
		AliasNames[32] = "LoadGame 1";
		AliasNames[33] = "SaveGame 2";
		AliasNames[34] = "LoadGame 2";
		AliasNames[35] = "Revolver";
		AliasNames[36] = "Gelziabar";
		AliasNames[37] = "Scythe";
		AliasNames[38] = "WarCannon";
		AliasNames[39] = "Shotgun";
		AliasNames[40] = "Speargun";
		AliasNames[41] = "Phoenix";
		AliasNames[42] = "Molotov";
		AliasNames[43] = "Ectoplasm";
		AliasNames[44] = "DispelMagic";
		AliasNames[45] = "Lightning";
		AliasNames[46] = "Haste";
		AliasNames[47] = "SkullStorm";
		AliasNames[48] = "Scrye";
		AliasNames[49] = "Shield";
		AliasNames[50] = "Invoke";
		AliasNames[51] = "PickDynamite";
		AliasNames[52] = "PickSilverBullet";
		AliasNames[53] = "PickPhosphorusShell";
		AliasNames[54] = "PickAmplifier";
		AliasNames[55] = "PickEtherTrap";
		AliasNames[56] = "FireDefSpell";
		AliasNames[57] = "SelectDefSpell";
		AliasNames[58] = "Talk";
		...
		LabelList[4] = "Weapon Action/Reload";
		...
		LabelList[22] = "Select Inventory";
		LabelList[23] = "Previous Weapon";
		LabelList[24] = "Next Weapon";
		LabelList[25] = "Previous Spell";
		LabelList[26] = "Next Spell";
		LabelList[27] = "Interface,Show Journal";
		LabelList[28] = "Display Objectives";
		LabelList[29] = "Save/Load,Quick Save";
		LabelList[30] = "Quick Load";
		LabelList[31] = "Save Slot 1";
		LabelList[32] = "Load Slot 1";
		LabelList[33] = "Save Slot 2";
		LabelList[34] = "Load Slot 2";
		LabelList[35] = "Fast Select,Revolver";
		LabelList[36] = "Gel'ziabar Stone";
		LabelList[37] = "Scythe";
		LabelList[38] = "War Cannon";
		LabelList[39] = "Shotgun";
		LabelList[40] = "Speargun";
		LabelList[41] = "Phoenix";
		LabelList[42] = "Molotov";
		LabelList[43] = "Ectoplasm";
		LabelList[44] = "Dispel Magic";
		LabelList[45] = "Lightning";
		LabelList[46] = "Haste";
		LabelList[47] = "Skull Storm";
		LabelList[48] = "Scrye";
		LabelList[49] = "Shield";
		LabelList[50] = "Invoke";
		LabelList[51] = "Dynamite";
		LabelList[52] = "Silver Bullets";
		LabelList[53] = "Phosphorus Shells";
		LabelList[54] = "Amplifier";
		LabelList[55] = "Ether Trap";
		LabelList[56] = "Renewal,Defensive Spell Fire";
		LabelList[57] = "Defensive Spell Select";
