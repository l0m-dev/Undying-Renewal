...
var() bool bNoFlight;		// don't generate flight connections.
var() bool bNoMinCollision;	// don't limit reachspecs to an arbitrary minimum cylinder.

native(519) final function describeSpec(int iSpec, out Actor Start, out Actor End, out int ReachFlags, out int Distance, out int ColRadius, out int ColHeight); 
