...
function PreBeginPlay()
{
    ...
    // If OtherSideURL="" then WarpZone will not
    // activate until triggered.

	/* Generate URL if necessary. Old functionality.
...
function Trigger( actor Other, pawn EventInstigator )
{
	...
	if ( (iNextDest > 7) || (Destinations[iNextDest] == "") )
		iNextDest = 0;

	OtherSideURL = Destinations[iNextDest];
	ForceGenerate();
}
