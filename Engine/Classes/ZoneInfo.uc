...
var() 		bool   bMagicalDamage;	// if a pain zone, should deliver damage of a magical type
...
event ActorEntered( actor Other )
{
	...
	// Kill Pawns if I am a KillZone
	if (bKillZone && Other.IsA('Pawn'))
		Pawn(Other).Died(P, DamageType, Other.Location, DInfo);
