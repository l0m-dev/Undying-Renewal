...
defaultproperties
{
     ...
     MOTDLine1Help="Show a message of the day when joining your server."
     MOTDLine2Text="MOTD Line 2"
     MOTDLine2Help="Show a message of the day when joining your server."
     MOTDLine3Text="MOTD Line 3"
     MOTDLine3Help="Show a message of the day when joining your server."
     MOTDLine4Text="MOTD Line 4"
     MOTDLine4Help="Show a message of the day when joining your server."
     ServerNameText="Server Name"
     ServerNameHelp="Enter the full description for your server."
