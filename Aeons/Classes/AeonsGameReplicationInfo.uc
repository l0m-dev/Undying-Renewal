//=============================================================================
// AeonsGameReplicationInfo.
//=============================================================================
class AeonsGameReplicationInfo extends GameReplicationInfo;
...
simulated function PostBeginPlay()
{
    ...
    /*
	if (AeonsGameInfo(Level.Game) != None)
	{
		TotalGames = AeonsGameInfo(Level.Game).EndStatsClass.Default.TotalGames;
		TotalFrags = AeonsGameInfo(Level.Game).EndStatsClass.Default.TotalFrags;
		TotalDeaths = AeonsGameInfo(Level.Game).EndStatsClass.Default.TotalDeaths;
		TotalFlags = AeonsGameInfo(Level.Game).EndStatsClass.Default.TotalFlags;
		for (i=0; i<3; i++)
		{
			BestPlayers[i] = AeonsGameInfo(Level.Game).EndStatsClass.Default.BestPlayers[i];
			BestFPHs[i] = AeonsGameInfo(Level.Game).EndStatsClass.Default.BestFPHs[i];
			BestRecordDate[i] = AeonsGameInfo(Level.Game).EndStatsClass.Default.BestRecordDate[i];
		}
	}
    */
}
