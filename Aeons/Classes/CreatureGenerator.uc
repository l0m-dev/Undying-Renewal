...
var bool			bInEffect;			// Generator waiting for effect time out.
var() bool			bRandomInterval;	// Generate randomly at specified interval.
var bool			bPendingEvent;		// Set when unable to generate when requested.
var() bool					bSpherical;			// Generation zone is spherical (not a cylinder).
var() bool			bTriggered;			// Generate by specified trigger.
...
var int				GenCount;			// Count of creatures generated.
var() int					MaxAlive;			// Maximum alive at any time.
var() int			MaxGenerated;		// Maximum total creatures generated.
var vector			SpawnLocation;		// Where the spawn is happening.
...
var float			TriggerTimer;		// Actual delay between trigger and activation.
